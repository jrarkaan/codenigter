			...
			<form method="post" action="">
				<div class="card-body pb-2">
					<div class="row form-group">
						...
						<div class="col-md-6">
							<input value="<?= $row->id_car?>" type="hidden" name="car_id" id="car_id">
							<input value="<?= $this->input->post('namamobil') ? $this->input->post('namamobil') : $row->namamobil?>" type="text" id="namamobil" name="namamobil" class="form-control" placeholder="Nama Mobilnya..">
					...
					<div class="row form-group">
						...
						<div class="col-md-6">
							<input value="<?= $this->input->post('plat') ? $this->input->post('plat') : $row->plat?>" type="text" id="plat" name="plat" class="form-control" placeholder="Plat Mobilnya..">
