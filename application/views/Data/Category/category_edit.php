			...
			<form method="post" action="">
				<div class="card-body pb-2">
					<div class="row form-group">
						...
						<div class="col-md-6">
							<input value="<?= $row->category_id?>" type="hidden" name="id_category" id="id_category">
							<input value="<?= $this->input->post('category_name') ? $this->input->post('category_name') : $row->name?>" type="text" id="category_name" name="category_name" class="form-control" placeholder="Nama Kategorinya..">
